/*
文件功能：定义数据库根节点的显示、节点创建和执行函数。
File purpose: Defines the database root node rendering, node factory, and execution function.
*/
...
const FILENAMES_OUTPUT_KEY = 'filenames'
...
const databaseRootDefinition = new DatabaseRootNodeDefinition()
...
function describeFilenameOutput(output: DatabaseRootOutput): string {
...
export async function executeDatabaseRootNode(_inputs: unknown[]): Promise<unknown[]> {
